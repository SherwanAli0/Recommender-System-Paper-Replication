...
Hypothesis test for Person 3 GIM baseline:

  H_GIM_1: floor / round post-processing on predictions, mirroring the FUS
           replication finding. Person 3's faithful GIM lands at MAE_users
  ...
  H_GIM_2: positive_only=False vs True. The Al-Shamri 2008 paper uses both
           positive and negative ratings; Person 3 defaults to positive_only=True
