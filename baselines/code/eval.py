...
# k sweep - shared_contract.md §6 (the baselines implementation caps at 10 for PF/GIM).
...
def main() -> None:
    print("=" * 60)
    print("the baselines implementation - Reference Baselines: PF + GIM  (Protocol A)")
    print("=" * 60)
