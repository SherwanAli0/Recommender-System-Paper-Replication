# Past Tests — Person 1 Faithful Baseline
...
**To run**: `python past_tests/code/regenerate_plots_approx.py` from the Person 1 root.
...
For a full account of the replication investigation and all hypotheses tested, see `../../Person_2_Faithful_FUS/REPRO_DEBUG_NOTES.md`.
