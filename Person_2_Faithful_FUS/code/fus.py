"""
fus.py — Person 2 / Stream P2 (Novelty)
Independent faithful re-implementation of pure FUS (paper Eqs 1-19).
Person 1 implements the same independently; duplication is intentional
for cross-verification. Do NOT look at Person 1's code.
