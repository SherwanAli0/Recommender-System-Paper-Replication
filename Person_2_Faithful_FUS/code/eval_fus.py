"""
eval_fus.py - Person 2 / Stream P2 (Faithful FUS only, no novelty)
...
The novelty (Adaptive Genre-Hybrid) and Protocol B (cold-start) are NOT
included in this Implementation release. See the original Person_2_Novelty
folder for those artefacts.
